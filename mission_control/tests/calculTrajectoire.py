...
def calculate_trajectory(GS, HDG_GS, WS, HDG_WS, plane_alt, Area, mass, CD=0.5, VerticalSpeed=0, target_alt=0):
# def calculate_trajectory(GS, HDG_GS, WS, HDG_WS, VerticalSpeed, target_alt, plane_alt, Area, mass, CD):
    #Initial parameters
    t = 0
    dt = 0.01
    dx_parcouru = 0
...
dx, dy = calculate_trajectory(GS, HDG_GS, WS, HDG_WS, VerticalSpeed, target_alt, plane_alt, Area, mass, CD)
